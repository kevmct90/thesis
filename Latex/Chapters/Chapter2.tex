...
ANN suffer because of their black box nature where users do not know what the inputs are to the outputs.
It is also recommended that a large number of training parameters should be used when trying to generate a good forecast including data scaling, learning rate, training tolerance, number of iterations, number of hidden neurons and layers plus more \citep{kaastra_forecasting_1995} 
