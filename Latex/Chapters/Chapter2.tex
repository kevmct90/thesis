...
\begin{table}[]
	...
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		\multicolumn{2}{|c|}{\multirow{2}{*}{Confusion Matrix}} & \multicolumn{2}{c|}{Target}                                                                                                           & \multirow{2}{*}{}                   \\ \cline{3-4}
		\multicolumn{2}{|c|}{}                                  & Positive                                                          & Negative                                                          &                                     \\ \hline
		\multirow{2}{*}{Model}            & Positive            & $a$                                                                 & $b$                                                                 & Positive Predictive Value $= a/(a+b)$  \\ \cline{2-5}
		& Negative            & $c$                                                                 & $d$                                                                 & Negative Predictive Value $= d/(c+d)$ \\ \hline
		\multicolumn{2}{|c|}{}                                  & \begin{tabular}[c]{@{}c@{}}Sensitivity\\ $=$\\ $a/(a+c)$\end{tabular} & \begin{tabular}[c]{@{}c@{}}Specificity\\ $=$\\ $d/(b+d)$\end{tabular} & Accuracy $= (a+d)/(a+b+c+d)$          \\ \hline
	\end{tabular}
\end{table}
