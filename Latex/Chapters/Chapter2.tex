...
Information gain is used to measure the decrease in entropy after the dataset is split on a feature. The aim is to find features that return the highest information gain. The equation for the information is 
...
Small tree preferred to large to avoid overfit
