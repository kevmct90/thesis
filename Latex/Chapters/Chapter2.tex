...
\cite{fama_term_1986} notes how over the counter derivatives broker-dealers measure using individual counter-parties details but also geographic data and also performance of other industry groups. The \cite{derivatives_policy_group_framework_1995} \footnote{The Derivatives Policy Group was made up of representatives of CS First Boston, Goldman Sachs, Morgan Stanley, Merrill Lynch, Salomon Brothers, and Lehman Brothers} made recommendations that recommended that credit exposure was measured by geography and industry exposure.

\cite{duffie_credit_2012}
