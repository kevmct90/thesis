...
\begin{figure}[htp]
	\centering
	\includegraphics[width=.32\textwidth, keepaspectratio=true]{Grouped_Features_Correlation_Analysis_Subset}\quad
	\includegraphics[width=.32\textwidth, keepaspectratio=true]{SME_Arrears_Trends_Correlation_Analysis_Subset}\quad
	\includegraphics[width=.32\textwidth,keepaspectratio=true]{Personal_Arrears_Ratio}
	\medskip
	\includegraphics[width=.32\textwidth, keepaspectratio=true]{Visa_Debit_Correlation_Analysis_Subset}\quad
	\includegraphics[width=.32\textwidth, keepaspectratio=true]{CSO_Correlation_Analysis}
