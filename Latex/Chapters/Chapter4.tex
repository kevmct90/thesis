...
\begin{figure}[H]
	...
	\caption{Percentage of Customers in arrears}
	\label{fig:percentageArrears}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.85\textwidth,height=6cm, center]{SME_Status}
	\caption{SME Customers Performance}
	\label{fig:SME_Status}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.85\textwidth,height=6cm, center]{ChangesInArrears}
	\caption{Monthly Changes Customers Leaving and going into arrears}
	\label{fig:ChangesInArrears}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.6\textwidth,center]{NewArrearsByLA}
	\caption{New Arrears by County}
	\label{fig:NewArrearsByLA}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.6\textwidth,center]{NewArrearsByED}
	\caption{New Arrears by Electoral Division}
