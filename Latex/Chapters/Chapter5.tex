...
As part of this experiment two methods of re-sampling data will be carried by means of oversampling and synthetic sampling. These experiments will evaluate whether 
...
\begin{table}[H]
	...
	\small
		\begin{tabular}{l l l r r r r}
			\hline
			\textbf{Model} & \textbf{Recall} & \textbf{Specificity} & \textbf{BA} & \textbf{AUC}  \\ \hline
			\textit{PD\_OverBench\_R} & 0.587 & 0.615 & 0.601 & 0.651   \\ \hline
			\textit{NPD\_OverBench\_R} & 0.559 & 0.720 & 0.640 & 0.67   \\ \hline
		\end{tabular}
...
\small
		\begin{tabular}{l  r r r r}
			\hline
			\textbf{Model} & \textbf{Recall} & \textbf{Specificity} & \textbf{BA} & \textbf{AUC}  \\ \hline
			\textit{PD\_Over\_RF10\_R}  & 0.569 & 0.662 & 0.615 & 0.666   \\ \hline
			\textit{NPD\_Over\_IG5\_R} & 0.553 & 0.711 & 0.632 & 0.688   \\ \hline
		\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{l  r r r r}
		\hline
		\textbf{Model} & \textbf{Recall} & \textbf{Specificity} & \textbf{BA} & \textbf{AUC}  \\ \hline
		\textit{PD\_Synthetic\_RF10\_R}  & 0.444 & 0.803 & 0.624 & 0.650   \\ \hline
		\textit{NPD\_Synthetic\_IG5\_R} & 0.604 & 0.661 & 0.633 & 0.663   \\ \hline
	\end{tabular}
	\caption{Experiment Oversampling Model Results for Experiment Comparison}
