...
\end{figure}
\begin{figure}[H]
	\includegraphics[width=1.30\textwidth,height=.75\textheight, center]{Visa_Debit_Correlation_Analysis}
...
\end{figure}
\begin{figure}[H]
	\includegraphics[width=1.30\textwidth,height=.75\textheight, center]{Balanced_Visa_Debit_Correlation_Analysis}
