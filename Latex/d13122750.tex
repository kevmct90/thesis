		...
		\begin{center}
			...
			\begin{minipage}{0.4\textwidth}
				\begin{flushleft} \large
					\textbf{\emph{Author:}}\\
					{\textbf{\authornames}} % Author name - remove the \href bracket to remove the link
				\end{flushleft}
			\end{minipage}
			\begin{minipage}{0.5\textwidth}
				\begin{flushright} \large
					\textbf{\emph{Supervisor:}} \\
					\textbf{\supname} % Supervisor name - remove the \href bracket to remove the link  
				\end{flushright}
			\end{minipage}\\[1.5cm]
			
			\begin{figure}[H]
				\includegraphics[width=0.4\textwidth, center]{DIT_logocol2013.jpg}
